    ...
    return (
        <section id="projects" className="bg-white section-padding">
            <div className="container mx-auto px-4">
                ...
                <div className="flex justify-center fade-in mb-6 space-x-4 flex-wrap">
                    <button
                ...
                <div className="text-center mt-8">
                    <Link href="/projects" className="bg-gradient-primary rounded-md text-white font-semibold hover:opacity-90 inline-block px-6 py-3 transition">View All Projects</Link>
                </div>
            </div>
        </section>
    );
