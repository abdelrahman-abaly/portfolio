...
export default function Hero() {
    ...
    return (
        <header id='hero' className="h-screen bg-gradient-primary text-white flex items-center pt-10 md:pt-0">
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row items-center justify-around">
                    <div className="max-w-2xl mb-8 md:mb-0">
                        <h1 className="text-4xl md:text-6xl font-semibold mb-4">Abdulrahman Abaly</h1>
